...
sep(tEx)
lbl(tEx,">> MINING DUPLICATION")
btn(tEx,"Dup Mining x10",function() if cd() then pcall(function() for i=1,10 do for _,r in pairs(RS:GetDescendants()) do if r:IsA("RemoteEvent") and (r.Name:lower():find("mine") or r.Name:lower():find("dig") or r.Name:lower():find("ore") or r.Name:lower():find("resource") or r.Name:lower():find("gather")) then r:FireServer() task.wait(0.1) end end end end) ntf("Mining","Fired x10!") end end,"dupmine10")
btn(tEx,"Dup Mining x50",function() if cd() then pcall(function() for i=1,50 do for _,r in pairs(RS:GetDescendants()) do if r:IsA("RemoteEvent") and (r.Name:lower():find("mine") or r.Name:lower():find("dig") or r.Name:lower():find("ore") or r.Name:lower():find("resource") or r.Name:lower():find("gather")) then r:FireServer() task.wait(0.05) end end end end) ntf("Mining","Fired x50!") end end,"dupmine50")
btn(tEx,"Dup Mining x100",function() if cd() then pcall(function() for i=1,100 do for _,r in pairs(RS:GetDescendants()) do if r:IsA("RemoteEvent") and (r.Name:lower():find("mine") or r.Name:lower():find("dig") or r.Name:lower():find("ore") or r.Name:lower():find("resource") or r.Name:lower():find("gather")) then r:FireServer() task.wait(0.02) end end end end) ntf("Mining","Fired x100!") end end,"dupmine100")
btn(tEx,"Dup Inventory x10",function() if cd() then pcall(function() local r=findRemote("Inventory.Inventory") if r then for i=1,10 do r:FireServer("duplicate") task.wait(0.1) end ntf("Inventory","Fired x10!") end end) end end,"dupinv10")
btn(tEx,"Dup Inventory x50",function() if cd() then pcall(function() local r=findRemote("Inventory.Inventory") if r then for i=1,50 do r:FireServer("duplicate") task.wait(0.05) end ntf("Inventory","Fired x50!") end end) end end,"dupinv50")
btn(tEx,"Dup Inventory x100",function() if cd() then pcall(function() local r=findRemote("Inventory.Inventory") if r then for i=1,100 do r:FireServer("duplicate") task.wait(0.02) end ntf("Inventory","Fired x100!") end end) end end,"dupinv100")
sep(tEx)
lbl(tEx,">> SPAWN MONEY / ITEMS")
btn(tEx,"Spawn Money x10",function() if cd() then pcall(function() for _,r in pairs(RS:GetDescendants()) do if r:IsA("RemoteEvent") and (r.Name:lower():find("money") or r.Name:lower():find("cash") or r.Name:lower():find("pay") or r.Name:lower():find("salary") or r.Name:lower():find("reward")) then for i=1,10 do r:FireServer(999999) task.wait(0.1) end end end end) ntf("Money","Fired x10!") end end,"spawnmoney10")
btn(tEx,"Spawn Money x50",function() if cd() then pcall(function() for _,r in pairs(RS:GetDescendants()) do if r:IsA("RemoteEvent") and (r.Name:lower():find("money") or r.Name:lower():find("cash") or r.Name:lower():find("pay") or r.Name:lower():find("salary") or r.Name:lower():find("reward")) then for i=1,50 do r:FireServer(999999) task.wait(0.05) end end end end) ntf("Money","Fired x50!") end end,"spawnmoney50")
btn(tEx,"Spam Buy Item x100",function() if cd() then pcall(function() local r=findRemote("SupermarketEvent.BuyItem") if r then for i=1,100 do r:FireServer() task.wait(0.02) end ntf("Buy","Fired x100!") end end) end end,"spambuy100")
btn(tEx,"Spam Claim Event x100",function() if cd() then pcall(function() local r=findRemote("ClaimEvent") if r then for i=1,100 do r:FireServer() task.wait(0.02) end ntf("Claim","Fired x100!") end end) end end,"spamclaim100")
btn(tEx,"Spam Efood x100",function() if cd() then pcall(function() local r=findRemote("efood.efoodJob") if r then for i=1,100 do r:FireServer() task.wait(0.02) end ntf("Efood","Fired x100!") end end) end end,"spamefood100")
sep(tEx)
sep(tEx)
